    ...
    <div className="min-h-screen bg-[#fdfaf5] text-gray-800 font-sans">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold font-heading text-gray-900 mb-6">Ready to Grow Your Business?</h2>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Get a professional website layout for your {industryName.toLowerCase()} business in 24 hours. No commitment required.
          </p>
          <Button size="lg" className="h-14 px-10 text-lg bg-[#FD9800] hover:bg-[#e08600] text-white rounded-lg shadow-lg">
            Build My Site Preview
          </Button>
        </div>
      </section>
