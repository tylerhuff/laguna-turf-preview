    ...
    <div className="min-h-screen bg-white text-gray-800 font-sans flex flex-col">
      ...
      <main className="flex-grow">
        <div className="pt-20 md:pt-32 pb-16 bg-[#fdfaf5]">
          <div className="container mx-auto px-6 max-w-4xl">
             ...
             <h1 className="text-4xl md:text-6xl font-bold font-heading text-gray-900 leading-[1.1] mb-6">
               Google Business Profile Basics for <span className="text-[#d97706]">Service Businesses</span>
             </h1>
        ...
        <article className="container mx-auto px-6 max-w-3xl py-16 md:py-24">
            <div className="prose prose-lg md:prose-xl max-w-none prose-headings:font-heading prose-headings:font-bold prose-headings:text-gray-900 prose-p:text-gray-700 prose-p:leading-relaxed prose-li:text-gray-700 prose-a:text-[#d67d00] prose-a:no-underline hover:prose-a:underline">
               <p className="lead text-2xl font-light text-gray-800 mb-10">
               ...
               <h2 className="text-3xl mt-12 mb-6">What it is</h2>
               <p>
               ...
               <div className="my-10 bg-[#fff8ed] border border-[#d97706]/30 rounded-2xl p-8">
                 <h3 className="text-[#9a5303] text-lg font-bold uppercase tracking-wide mb-4 mt-0">Did you know?</h3>
               ...
               <h2 className="text-3xl mt-12 mb-6">Why it matters</h2>
               <p>
               ...
               <h2 className="text-3xl mt-12 mb-6">The Basics of Optimization</h2>
               <p>
               ...
               <ul className="list-none pl-0 space-y-4 my-6">
                 <li className="flex items-start gap-3 pl-0">
                   <CheckCircle2 className="w-6 h-6 text-[#d97706] shrink-0 mt-1" />
               ...
               <h2 className="text-3xl mt-12 mb-6">How we help</h2>
               <p>
          ...
          <div className="mt-16 pt-10 border-t border-gray-100">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/contact-us">
                <Button size="lg" className="w-full sm:w-auto bg-[#d97706] hover:bg-[#b45309] text-white font-bold h-12 px-8">
                  Get a Free Audit
                </Button>
              </Link>
              <Link href="/resources">
                <Button variant="outline" size="lg" className="w-full sm:w-auto border-gray-300 hover:border-[#d97706] hover:text-[#d97706] h-12 px-8">
                  Read More Guides
                </Button>
              </Link>
            </div>
